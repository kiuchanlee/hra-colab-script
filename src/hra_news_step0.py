...
def main():
    ...
    "사업 재편", "사업 개편", "프라임 오피스", "중대재해사고", "노동 정책",
    ...
    # 🏢 지분투자/인수
    "삼성화재 인수", "삼성화재 M&A", "삼성화재 지분투자", 
    "현대해상 인수", "현대해상 M&A", "현대해상 지분투자", 
    "DB손보 인수", "DB손보 M&A", "DB손보 지분투자",
    "KB손보 인수", "KB손보 M&A", "KB손보 지분투자",
    "메리츠 인수", "메리츠 M&A", "메리츠 지분투자", 
    "삼성생명 인수", "삼성생명 M&A", "삼성생명 지분투자",
    "한화생명 인수", "한화생명 M&A", "한화생명 지분투자",
    "교보생명 인수", "교보생명 M&A", "교보생명 지분투자",
    "예별손보", "예별손보 인수"

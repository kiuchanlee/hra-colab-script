...
def main():
    ...
    "평균연봉", "근속", "포괄임금", "실업급여", "연금개혁","스톡옵션","RSU","임금분포제","퇴직금누진제",
    ...
    "손보사 조직 개편", "생보사 조직 개편", "보험사 사외이사", "손보사 생보사 사외이사", "손보 전략적 제휴", "생보 전략적 제휴","금융위", "CBCD"," "금융개혁", "혁신금융",
    "손보 노조", "생보 노조", "카드 노조", "은행 노조", "증권 노조"
    "금융권 조직", "보험사 조직", "손보 영입", "금융권 영입", "보험업계 영입", "보험업계 신설", "인사 담당 임원", "HR 담당 임원", 

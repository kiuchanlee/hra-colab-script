...
def main():
    ...
    "평균연봉", "근속", "포괄임금", "실업급여", "연금개혁","스톡옵션","RSU","임금분포제",
    ...
    "선택근로제", "근로시간 단축", "주4일제", "4.5일제", "단축근로", "근무시간", "육아휴직", "휴직제도", "출산휴가", "근속휴가", "사내복지",
    ...
    "삼성 인사", "삼성 임원진", "삼성 조직", "삼성 경영진", "삼성 조직개편", "삼성 영입", "삼성 출신", "삼성 발령", "삼성 사외이사","삼성 M&A",
    "현대해상 인사", "현대해상 임원진", "현대해상 조직", "현대해상 경영진", "현대해상 조직개편", "현대해상 영입", "현대해상 내정", "현대해상 출신", "현대해상 사외이사",
    "DB손보 인사", "DB손보 임원진", "DB손보 조직", "DB손보 경영진", "DB손보 조직개편", "DB손보 영입", "DB손보 내정", "DB손보 출신", "DB손보 사외이사",
    "KB손보 인사", "KB손보 임원진", "KB손보 조직", "KB손보 경영진", "KB손보 조직개편", "KB손보 영입", "KB손보 내정", "KB손보 출신", "KB손보 사외이사",
    "메리츠 인사", "메리츠 임원진", "메리츠 조직", "메리츠 경영진", "메리츠 조직개편", "메리츠 영입", "메리츠 내정", "메리츠 출신", "메리츠 사외이사",

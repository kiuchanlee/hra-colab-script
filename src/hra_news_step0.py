...
def main():
    ...
    "메리츠 인사", "메리츠 임원진", "메리츠 조직", "메리츠 경영진", "메리츠 조직개편", "메리츠 영입", "메리츠 출신", "메리츠 사외이사", "GA 영입", "GA 조직개편", "GA 인센티브", "GA 수수료", 
    "설계사 수수료", "설계사 인센티브", "설계사 영입", "설계사 빼가기", "금융위 인사", "금감원 인사", "재경부 인사", "금감원 조직개편",
    ...
    # 🏢 지분투자/인수
    "삼성화재 인수", "삼성화재 M&A", "삼성화재 지분투자", "손보사 인수", "생보사 인수", "손보사 지분투자", "생보사 지분투자", "손보사 M&A", "생보사 M&A",
    "현대해상 인수", "현대해상 지분투자", "DB손보 인수", "DB손보 지분투자", "KB손보 인수", "KB손보 지분투자", "메리츠 인수", "메리츠 지분투자", "삼성생명 인수", "삼성생명 지분투자",
    "한화생명 인수", "한화생명 지분투자", "교보생명 인수", "교보생명 지분투자", "재보험사", "재보험사 인수", "재보험사 지분투자",
